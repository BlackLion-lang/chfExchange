  ...
  return (
    <footer className="border-t border-white/20 glass-card">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className=" border-white/20 mt-1 pt-1 flex flex-col md:flex-row items-center justify-center text-sm text-white">
          <p>&copy; 2025 CHF Exchange. All rights reserved. | Regulated Swiss Stablecoin Platform</p>
